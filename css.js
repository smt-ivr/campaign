...
#zeout { order: 4; } 
#email { order: 5; } 
#solicitor-select { order: 6; }
#comment { order: 7; grid-column: span 3; } 
...
.sweet-overlay { 
    ...
    z-index: 10000; display: none; opacity: 0; transition: 0.3s ease; pointer-events: none;
}
.sweet-alert {
    ...
    z-index: 10001; opacity: 0; transition: 0.3s ease; box-shadow: 0 15px 40px rgba(0,0,0,0.15); border: 1px solid var(--border);
    box-sizing: border-box; 
}
